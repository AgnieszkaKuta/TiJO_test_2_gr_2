...
var fragments = function (text)
{
    ...
    var mapping = {
        goodNewsText: element.bind(null,by.id("kuta")),
        abcLabel: element.bind(null,by.id("agnieszka")),
        cdeLabel: element.bind(null,by.id("agnieszkakuta")),
        input: element.bind(null,by.id("sara"))
    };
